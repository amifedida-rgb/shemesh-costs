  ...
  <div class="fin-wrap">
    ...
    <div class="fin-cards">
      <div class="fin-card">
        ...
        <div class="fin-card-note">${finNum(Math.min(s.kwc,st.seuil_kw))} kW à ${String(s.offre==='acceleree'?st.tarif_acc_bas:st.tarif_cl_bas).replace('.',',')} ₪${s.kwc>st.seuil_kw?` · ${finNum(s.kwc-st.seuil_kw)} kW à ${String(st.tarif_haut).replace('.',',')} ₪`:''}</div>
      </div>
      <div class="fin-card">
