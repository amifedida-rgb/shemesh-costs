...
const PANEL_WATT_DEFAULT = 550;
const PANEL_AREA_DEFAULT = 2.28;   // m² par panneau
const PANEL_PRICE_WC_DEFAULT = 0.45;   // ₪ par Wc
...
function getPanelPriceWc(){
  try{
    const s=JSON.parse(localStorage.getItem(LS_SETTINGS)||'{}');
    const v=parseFloat(s.prixwc);
    return (v && v>0) ? v : PANEL_PRICE_WC_DEFAULT;
  }catch(e){ return PANEL_PRICE_WC_DEFAULT; }
}
